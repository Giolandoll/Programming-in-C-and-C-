 ...
 * Prints the elements of the queue in order from the front to the back
 * using a cursor to seek through each element along with a for loop 
 * iterating to the number of items in the queue.
 * 
 * @param pq The pointer to the queue structure.
 * 
*/
